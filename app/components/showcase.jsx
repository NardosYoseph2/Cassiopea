...
const caseStudiesData = [
  ...
  { id: 2, title: "Event Ticketing Mobile App", description: "Innovative event ticketing mobile app development for seamless user experience.", image: "/jorka.png", category: "Mobile App", link: "" },
  { id: 3, title: "API Integration", description: "Smooth integration of third-party APIs.", image: "/wow2.jpg", category: "Integration", link: "" }
];

const categories = ["All", "Web", "Mobile App", "Integration","Design","IoT"];
...
const PortfolioSection = () => {
  ...
  return (
    <section id="portfolio" className="py-12 bg-gray-100 w-full px-4 md:px-8 mt-24">
      ...
      <div className="text-end mt-8 ml-10">
        <a
          href="#"
